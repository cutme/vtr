		...
		var bLazy = new Blazy({
			...
			success: function(element){
				...
				if(window.location.hash) {
					vtr.Helper.goToTarget(window.location.hash, -80);
				}
...
*/
	...
	function cookies() {
	    ...
	    if (Cookies.get('vtrproperty-cookies') != 1) {
	    	setTimeout(function() {
	    ...
	    accept.on('click', function(e){
	        e.preventDefault();
	        Cookies.set("vtrproperty-cookies", 1, { expires: 356, path: '/' });
    ...
    function openSubmenu() {
		...
		close.on('click', function(e) {
			...
			if ( $(window).width() > 768 ) {
				...
				submenu_container.removeClass('is-active');
			}
		});
